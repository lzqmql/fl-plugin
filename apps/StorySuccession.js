    ...
    async ksyx(e) {
        ...
        if (e.msg.includes('讲述') & game == 1) {
            ...
            if (e.user_id == wanjia[huihe]) {
                ...
                data1 = {
                    tplFile: './plugins/Fl-Plugin/resources/html/StorySuccession/StorySuccession.html',
                    dz: ml,
                    wjname: wjname1,
                    msr: msr,
                    gsnr: gsnr,
