    ...
    async manhua(e) {
        ...
        if (e.msg.includes("#点漫画")) {
            ...
            try {
                ...
                lb.splice(0, 1)
                data1 = {
                    tplFile: './plugins/Fl-Plugin/resources/html/Cartoon/OrderCartoon.html',
                    dz: ml,
                    lb: lb,
                    tp: tpj
        ...
        if (e.msg.includes("#看漫画")) {
            ...
            data1 = {
                tplFile: './plugins/Fl-Plugin/resources/html/Cartoon/OrderHide.html',
                dz: ml,
                name: name,
                js: js,
                tp: tpj[id]
        ...
        if (e.msg.includes("#选漫画") & e.isPrivate) {
            ...
            for (let g = 0; g < cs; g++) {
                g2 = g + 1
                data1 = {
                    tplFile: './plugins/Fl-Plugin/resources/html/Cartoon/Cartoon.html',
                    dz: ml,
