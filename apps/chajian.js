...
export class example extends plugin {
  ...
  async cjxx(e) {
    ...
    if (e.msg == '#插件详细目录') {
      bt = '插件详细目录'
      let data1 = {
        tplFile: './plugins/Fl-Plugin/resources/html/cjb/cjxqml.html',
        dz: ml,
        shuju: mulu,
    ...
    let data1 = {
      tplFile: './plugins/Fl-Plugin/resources/html/cjb/cjxq.html',
      dz: ml,
      shuju: id,
      url: "https://www.loliapi.com/acg/pe",
      bt: bt
  ...
  async azcj(e) {
    ...
    fs.readFile('./plugins/Fl-Plugin/resources/html/cjb/zsj.json', 'utf8', async (err, data) => {
      if (err) {
  ...
  async guanli(e) {
    ...
    try {
      ...
      fs.readFile('./plugins/Fl-Plugin/resources/html/cjb/zsj.json', 'utf8', async (err, data) => {
        ...
        let data1 = {
          tplFile: './plugins/Fl-Plugin/resources/html/cjb/cjb.html',
          dz: ml,
          shuju: shuju,
          url: "https://www.loliapi.com/acg/pe",
          bt: bt
