...
const helpPath = `${_path}/plugins/Fl-Plugin/resources/help`
...
export class Help extends plugin {
  constructor() {
    super({
      ...
      rule: [
        {
          reg: "^#?(风铃|土堆|泥土|土|赌怪)?(命令|帮助|菜单|help|说明|功能|指令|使用说明)$",
          fnc: 'help'
        },
        {
          reg: "^#?风铃版本$",
  ...
  async help(e) {
    if ((!/风铃/.test(e.msg)) && (!/土堆/.test(e.msg)) && (!/泥土/.test(e.msg)) && (!/土/.test(e.msg)) && (!/赌怪/.test(e.msg)) && !Cfg.get('sys.help', false)) {
      return false
    }
