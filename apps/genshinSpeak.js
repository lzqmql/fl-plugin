...
export class GenshinSpeak extends plugin {
    ...
    async cyy(e) {
        ...
        if (e.msg == '原神猜语' | e.msg == '猜语音' & ks == 0) {
            ...
            ks = 1
            const dir = './plugins/Fl-Plugin/resources/html/GenshinSpeak/Characters/';
            ...
            let jsdz = ml + "/plugins/Fl-Plugin/resources/html/GenshinSpeak/" + "Characters/" + wenj2[i] + ".txt"
            let wb = ""
        ...
        if (e.msg.includes('#我猜') & ks == 1) {
            ...
            if (caice == daan) {
                ...
                data1 = {
                    tplFile: './plugins/Fl-Plugin/resources/html/GenshinSpeak/GuessVideo.html',
                    dz: ml,
                    wjname: wjname,
                    fen: fen,
                    huihe: huihe
    ...
    async tingyy(e) {
        ...
        let jsdz = ml + "/plugins/Fl-Plugin/resources/html/GenshinSpeak/" + "Characters/" + name4 + ".txt"
        ...
        let li = fs.readFileSync('./plugins/Fl-Plugin/resources/json/mohu/mohu.json', 'utf-8')
        li = JSON.parse(li)
        ...
        if (e.msg.includes("语音列表")) {
            ...
            data1 = {
                tplFile: './plugins/Fl-Plugin/resources/html/GenshinSpeak/index.html',
                dz: ml,
                nr2: yuyin,
                name: name4
    ...
    async liebiao(e) {
        ...
        console.log(name)
        const dir = './plugins/Fl-Plugin/resources/html/GenshinSpeak/Characters/' + name + '/';
