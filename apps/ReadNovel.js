	...
	async kanpian(e) {
		...
		if (e.msg.includes("#点小说") & zzss == 0) {
			...
			try {
				...
				if (nr2 != undefined) {
					data1 = {
						tplFile: './plugins/Fl-Plugin/resources/html/Novel/OrderNovel.html',
						dz: ml,
						nr2: nr2
					}
		...
		if (e.msg.includes("#看小说")) {
			...
			data1 = {
				tplFile: './plugins/Fl-Plugin/resources/html/Novel/OrderJs.html',
		...
		if (e.msg.includes("#选小说")) {
			...
			data1 = {
				tplFile: './plugins/Fl-Plugin/resources/html/Novel/Novel.html',
