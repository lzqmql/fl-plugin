...
const _cfgPath = `${_path}/plugins/Fl-Plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/Fl-Plugin/config/`
let defSetPath = './plugins/Fl-Plugin/defSet/'
